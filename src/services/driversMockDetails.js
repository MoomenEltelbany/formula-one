...
export const mockDrivers = [
    {
        id: "piastri",
        driverId: "piastri",
        number: "81", // this is his real race number
        code: "PIA",
        givenName: "Oscar",
        familyName: "Piastri",
        fullName: "Oscar Piastri",
        dateOfBirth: "2001-04-06", // you can confirm
    ...
    },
    {
        ...
        wins: 5,
        podiums: 14,
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/2024-08-25_Motorsport%2C_Formel_1%2C_Gro%C3%9Fer_Preis_der_Niederlande_2024_STP_3975_by_Stepro_%28cropped2%29.jpg/500px-2024-08-25_Motorsport%2C_Formel_1%2C_Gro%C3%9Fer_Preis_der_Niederlande_2024_STP_3975_by_Stepro_%28cropped2%29.jpg",
    },
    {
        id: "verstappen",
        driverId: "verstappen",
    ...
    },
    {
        ...
        wins: 2,
        podiums: 6,
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7f/KingsLeonSilverstne040724_%2828_of_112%29_%2853838006028%29_%28cropped%29.jpg/1280px-KingsLeonSilverstne040724_%2828_of_112%29_%2853838006028%29_%28cropped%29.jpg",
    },
    {
        id: "leclerc",
        driverId: "leclerc",
...

    {
        ...
        wins: 0,
        podiums: 0,
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/2025_Japan_GP_-_Aston_Martin_-_Lance_Stroll_-_Fanzone_Stage_%28cropped%29.jpg/1280px-2025_Japan_GP_-_Aston_Martin_-_Lance_Stroll_-_Fanzone_Stage_%28cropped%29.jpg",
    },
    ...
    },
    {
        ...
        dateOfBirth: "", // you’ll need to find this
        nationality: "Argentinian", // or “Argentine”
        team: "Alpine", // as per reports, rotating seat arrangement with Doohan :contentReference[oaicite:3]{index=3}
        teamId: "alpine",
        teamColor: "#025BA8", // placeholder, adjust to Alpine’s color
        points: 0, // placeholder (you’ll need the actual tally)
        position: null,
        wins: 0,
        podiums: 0,
...
// Helper function to get team logo (you can add actual logos later)
export const getTeamLogo = (teamId) => {
    const logos = {
        ...
        mclaren:
            "https://upload.wikimedia.org/wikipedia/en/thumb/6/66/McLaren_Racing_logo.svg/200px-McLaren_Racing_logo.svg.png",
        aston_martin:
        ...
        alpine: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/Alpine_F1_Team_Logo.svg/200px-Alpine_F1_Team_Logo.svg.png",
        williams:
            "https://upload.wikimedia.org/wikipedia/en/thumb/f/f9/Williams_Racing_logo.svg/200px-Williams_Racing_logo.svg.png",
        alphatauri:
            "https://upload.wikimedia.org/wikipedia/en/thumb/3/3d/Scuderia_AlphaTauri_logo.svg/200px-Scuderia_AlphaTauri_logo.svg.png",
        haas: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/Haas_F1_Team_Logo.svg/200px-Haas_F1_Team_Logo.svg.png",
        alfa: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/79/Alfa_Romeo_F1_Team_Orlen_Logo.svg/200px-Alfa_Romeo_F1_Team_Orlen_Logo.svg.png",
    };
    return logos[teamId] || "";
};
